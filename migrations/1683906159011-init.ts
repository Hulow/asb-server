...
export class init1683906159011 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "frequency" ("uid" uuid NOT NULL, "measured_by" varchar NOT NULL, "measured_from" varchar NOT NULL, "sampling" varchar NOT NULL, "measured_at" TIMESTAMP WITH TIME ZONE NOT NULL, "frequency_weightings" varchar NOT NULL, "target_level" integer NOT NULL, "measurement_note" varchar NOT NULL, "smoothing" integer NOT NULL, "measurements" integer NOT NULL, "efficiency" jsonb NOT NULL, "user_id" integer NOT NULL, "driver_id" integer NOT NULL, "cabinet_id" integer NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_e599b90870d9d3155e641063ca5" PRIMARY KEY ("uid"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "impulse" ("uid" uuid NOT NULL, "measured_by" varchar NOT NULL, "note" varchar NOT NULL, "source" varchar NOT NULL, "measured_at" TIMESTAMP WITH TIME ZONE NOT NULL, "sweep_length" varchar NOT NULL, "response_window" varchar NOT NULL, "sample_interval" varchar NOT NULL, "measurements" jsonb NOT NULL, "user_id" integer NOT NULL, "driver_id" jsonb NOT NULL, "cabinet_id" integer NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_296304c6522d65c506b46fbfe4a" PRIMARY KEY ("uid"))`,
    );
  }
