...
export class init1683906159011 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "cabinet" ("cabinet_uid" uuid NOT NULL, "brand_name" varchar NOT NULL, "product_name" varchar NOT NULL, "enclosure_type" varchar NOT NULL, "weight" float NOT NULL, "dimension" varchar NOT NULL, "manufacturing_year" integer NOT NULL, "description" varchar NOT NULL, "owner_uid" uuid NOT NULL, "impedance_uid" uuid NOT NULL UNIQUE, "frequency_uid" uuid NOT NULL UNIQUE, "impulse_uid" uuid NOT NULL UNIQUE, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_4b8cadc8a1d7af2b417fd5ca59f" PRIMARY KEY ("cabinet_uid"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "impedance" ("impedance_uid" uuid NOT NULL, "piston_diameter" varchar NOT NULL, "resonance_frequency" varchar NOT NULL, "dc_resistance" varchar NOT NULL, "ac_resistance" float NOT NULL, "mechanical_damping" varchar NOT NULL, "electrical_damping" integer NOT NULL, "total_damping" varchar NOT NULL, "equivalence_compliance" integer NOT NULL, "voice_coil_inductance" integer NOT NULL, "efficiency" integer NOT NULL, "sensitivity" integer NOT NULL, "cone_mass" integer NOT NULL, "suspension_compliance" integer NOT NULL, "force_factor" integer NOT NULL, "kr" integer NOT NULL, "xr" integer NOT NULL, "ki" integer NOT NULL, "xi" integer NOT NULL, "owner_id" uuid NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_197314cb3b86f25abee280469ff" PRIMARY KEY ("impedance_uid"))`,
    );
    await queryRunner.query(
